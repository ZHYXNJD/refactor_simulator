...
from config import *
from simulator_pricing.utilities import utilities
...
class SimulatorTrainer:
    def __init__(self, simulator, pricing_agent, matching_agent,dynamic_matching_agent):
    ...
    def generate_warmup_data(self,train_config):
        ...
        with open(write_path+f'/transition_data_10min.pkl', 'wb') as f:
