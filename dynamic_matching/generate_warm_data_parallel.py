...
def run_simulation_and_train(config,worker_id):
    ...
    trainer.generate_warmup_data(
        train_config={
            ...
            'driver_num': 1000,
            'output_path': "warmup_transitions/rl_compare",
            'parallel': True,
            'worker_id': worker_id,
...
if __name__ == "__main__":
    ...
    tasks = [
        ...
        {'grid_num': 63, 'decision_freq': 10, 'experiment_mode': 'generate_warmup_data',
         'pickup_mode': 'ma', 'method': 'dynamic_matching', 'load_path': QTABLE_WEIGHT_DICT[(63, 10)],
         "agent_type": "idqn"},
        {'grid_num': 35, 'decision_freq': 10, 'experiment_mode': 'generate_warmup_data',
         'pickup_mode': 'ma', 'method': 'dynamic_matching', 'load_path': QTABLE_WEIGHT_DICT[(35, 10)],
         "agent_type": "idqn"},
        {'grid_num': 8, 'decision_freq': 10, 'experiment_mode': 'generate_warmup_data',
