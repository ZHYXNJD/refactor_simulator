...
G = ox.load_graphml('/manhattan/data/manhattan.graphml')
...
for i in tqdm(range(22,23)):
    end_date = parser.parse('2015-05-'+str(i+1))
    date = '2015-05-' + str(i)
    start_date = parser.parse('2015-05-'+str(i))
    ...
    pd_data['trip_time'] = 0
    pd_data['designed_reward'] = data.fareAmount.values.tolist()
