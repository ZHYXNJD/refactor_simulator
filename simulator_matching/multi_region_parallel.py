...
def run_simulation_and_train(config,worker_id):
    ...
    trainer.dynamic_matching_train(
        train_config={
            ...
            'output_path': "../../root/autodl-tmp/sensitivity_analysis_new_parameter_test",
            'flag_load': True,
            'parallel': True,
            'worker_id': worker_id,
...
if __name__ == "__main__":
    ...
    # 12种情况
    tasks = [
        # {'grid_num': 8, 'decision_freq': 30,'order_sample_ratio': 1,'experiment_mode': 'train_dynamic_matching','pickup_mode': 'ma','driver_num': 1000,'method':'dynamic_matching','load_path':QTABLE_WEIGHT_DICT[(8,30)],
        #  "lr_actor": 1e-05,"lr_critic": 0.0005,"gamma": 0.95,"tau": 0.005,"buffer_size": 5000,"batch_size": 16,"action_var": 0.3,"update": 3},
        # {'grid_num': 8, 'decision_freq': 20,'order_sample_ratio': 1,'experiment_mode': 'train_dynamic_matching','pickup_mode': 'ma','driver_num': 1000,'method':'dynamic_matching','load_path':QTABLE_WEIGHT_DICT[(8,20)],
        #  "lr_actor": 1e-05,"lr_critic": 0.0005,"gamma": 0.95,"tau": 0.005,"buffer_size": 5000,"batch_size": 16,"action_var": 0.3,"update": 3},
        # {'grid_num': 8, 'decision_freq': 10,'order_sample_ratio': 1,'experiment_mode': 'train_dynamic_matching','pickup_mode': 'ma','driver_num': 1000,'method':'dynamic_matching','load_path':QTABLE_WEIGHT_DICT[(8,10)],
        #  "lr_actor": 1e-05,"lr_critic": 0.0005,"gamma": 0.95,"tau": 0.005,"buffer_size": 5000,"batch_size": 16,"action_var": 0.3,"update": 3},
        # {'grid_num': 8, 'decision_freq': 5,'order_sample_ratio': 1,'experiment_mode': 'train_dynamic_matching','pickup_mode': 'ma','driver_num': 1000,'method':'dynamic_matching','load_path':QTABLE_WEIGHT_DICT[(8,5)],
        #  "lr_actor": 1e-05,"lr_critic": 0.0005,"gamma": 0.95,"tau": 0.005,"buffer_size": 5000,"batch_size": 16,"action_var": 0.3,"update": 3},
        # {'grid_num': 63, 'decision_freq': 10,'order_sample_ratio': 1,'experiment_mode': 'train_dynamic_matching','pickup_mode': 'ma','driver_num': 1000,'method':'dynamic_matching','load_path':QTABLE_WEIGHT_DICT[(63,10)],
        ...
        # {'grid_num': 63, 'decision_freq': 5, 'order_sample_ratio': 1, 'experiment_mode': 'train_dynamic_matching',
        #  'pickup_mode': 'ma', 'driver_num': 1000, 'method': 'dynamic_matching',
        #  'load_path': QTABLE_WEIGHT_DICT[(63, 5)],
        ...
        {'grid_num': 63, 'decision_freq': 5, 'order_sample_ratio': 1, 'experiment_mode': 'train_dynamic_matching',
         ...
         'load_path': QTABLE_WEIGHT_DICT[(63, 5)],
         "lr_actor": 1e-05, "lr_critic": 0.0005, "gamma": 0.95, "tau": 0.005, "buffer_size": 15000, "batch_size": 32,
         "action_var": 0.3, "update": 3,"actor_hidden":[128,128],"critic_hidden":[256,256]},
        {'grid_num': 63, 'decision_freq': 5, 'order_sample_ratio': 1, 'experiment_mode': 'train_dynamic_matching',
         'pickup_mode': 'ma', 'driver_num': 1000, 'method': 'dynamic_matching',
         'load_path': QTABLE_WEIGHT_DICT[(63, 5)],
         "lr_actor": 1e-05, "lr_critic": 0.0005, "gamma": 0.95, "tau": 0.005, "buffer_size": 15000, "batch_size": 32,
         "action_var": 0.3, "update": 3, "actor_hidden": [128,128], "critic_hidden": [512,512]},
        {'grid_num': 63, 'decision_freq': 5, 'order_sample_ratio': 1, 'experiment_mode': 'train_dynamic_matching',
         'pickup_mode': 'ma', 'driver_num': 1000, 'method': 'dynamic_matching',
         'load_path': QTABLE_WEIGHT_DICT[(63, 5)],
         "lr_actor": 1e-05, "lr_critic": 0.0005, "gamma": 0.95, "tau": 0.005, "buffer_size": 20000, "batch_size": 32,
         "action_var": 0.3, "update": 3,"actor_hidden":[128,128],"critic_hidden":[256,256]},
        {'grid_num': 63, 'decision_freq': 5, 'order_sample_ratio': 1, 'experiment_mode': 'train_dynamic_matching',
         'pickup_mode': 'ma', 'driver_num': 1000, 'method': 'dynamic_matching',
         'load_path': QTABLE_WEIGHT_DICT[(63, 5)],
         "lr_actor": 1e-05, "lr_critic": 0.0005, "gamma": 0.95, "tau": 0.005, "buffer_size": 40000, "batch_size": 64,
         "action_var": 0.3, "update": 3, "actor_hidden": [128,128], "critic_hidden": [256,256]},
        {'grid_num': 63, 'decision_freq': 5, 'order_sample_ratio': 1, 'experiment_mode': 'train_dynamic_matching',
         'pickup_mode': 'ma', 'driver_num': 1000, 'method': 'dynamic_matching',
         'load_path': QTABLE_WEIGHT_DICT[(63, 5)],
         "lr_actor": 1e-05, "lr_critic": 0.0005, "gamma": 0.95, "tau": 0.005, "buffer_size": 40000, "batch_size": 128,
         "action_var": 0.3, "update": 3, "actor_hidden": [256,256], "critic_hidden": [256,256]},
        {'grid_num': 63, 'decision_freq': 5, 'order_sample_ratio': 1, 'experiment_mode': 'train_dynamic_matching',
         'pickup_mode': 'ma', 'driver_num': 1000, 'method': 'dynamic_matching',
         'load_path': QTABLE_WEIGHT_DICT[(63, 5)],
         "lr_actor": 1e-05, "lr_critic": 0.0005, "gamma": 0.95, "tau": 0.005, "buffer_size": 50000, "batch_size": 256,
         "action_var": 0.3, "update": 3, "actor_hidden": [128,128], "critic_hidden": [256,256]},
        {'grid_num': 63, 'decision_freq': 5, 'order_sample_ratio': 1, 'experiment_mode': 'train_dynamic_matching',
         'pickup_mode': 'ma', 'driver_num': 1000, 'method': 'dynamic_matching',
         'load_path': QTABLE_WEIGHT_DICT[(63, 5)],
         "lr_actor": 1e-05, "lr_critic": 0.0005, "gamma": 0.95, "tau": 0.005, "buffer_size": 50000, "batch_size": 256,
         "action_var": 0, "update": 3, "actor_hidden": [128,128], "critic_hidden": [256,256]},
        {'grid_num': 63, 'decision_freq': 5, 'order_sample_ratio': 1, 'experiment_mode': 'train_dynamic_matching',
         'pickup_mode': 'ma', 'driver_num': 1000, 'method': 'dynamic_matching',
         'load_path': QTABLE_WEIGHT_DICT[(63, 5)],
         "lr_actor": 5e-05, "lr_critic": 5e-03, "gamma": 0.95, "tau": 0.005, "buffer_size": 50000, "batch_size": 256,
         "action_var": 0.3, "update": 3, "actor_hidden": [128,128], "critic_hidden": [256,256]},
        {'grid_num': 63, 'decision_freq': 5, 'order_sample_ratio': 1, 'experiment_mode': 'train_dynamic_matching',
         'pickup_mode': 'ma', 'driver_num': 1000, 'method': 'dynamic_matching',
         'load_path': QTABLE_WEIGHT_DICT[(63, 5)],
         "lr_actor": 5e-04, "lr_critic": 5e-03, "gamma": 0.95, "tau": 0.005, "buffer_size": 50000, "batch_size": 128,
         "action_var": 0.3, "update": 3, "actor_hidden": [256,256], "critic_hidden": [512,512]},
        {'grid_num': 63, 'decision_freq': 5, 'order_sample_ratio': 1, 'experiment_mode': 'train_dynamic_matching',
         'pickup_mode': 'ma', 'driver_num': 1000, 'method': 'dynamic_matching',
         'load_path': QTABLE_WEIGHT_DICT[(63, 5)],
         "lr_actor": 5e-04, "lr_critic": 5e-03, "gamma": 0.95, "tau": 0.005, "buffer_size": 50000, "batch_size": 128,
         "action_var": 0, "update": 3, "actor_hidden": [128,128], "critic_hidden": [512,512]},
        {'grid_num': 63, 'decision_freq': 5, 'order_sample_ratio': 1, 'experiment_mode': 'train_dynamic_matching',
         'pickup_mode': 'ma', 'driver_num': 1000, 'method': 'dynamic_matching',
         'load_path': QTABLE_WEIGHT_DICT[(63, 5)],
         "lr_actor": 5e-04, "lr_critic": 5e-03, "gamma": 0.95, "tau": 0.005, "buffer_size": 20000, "batch_size": 128,
         "action_var": 0, "update": 1, "actor_hidden": [256,256], "critic_hidden": [512,512]}
    ]
